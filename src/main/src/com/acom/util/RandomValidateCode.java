...
public class RandomValidateCode {
    ...
    public void getRandCode(HttpServletRequest request, HttpServletResponse response) {
        ...
        //Cookie cookie = new Cookie(imageKey, randomString);
        // response.addCookie(cookie);
        //2：将随机生成的验证码放入session中
        String sessionId = request.getSession().getId();
        request.getSession().setAttribute(sessionId + Constants.AdminConstant.ADMIN_IMAGE_CODE_KEY, randomString);
        System.out.println(sessionId + "*************" + randomString);
